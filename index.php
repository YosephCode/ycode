...
<!--[if IE 8]>         <html xmlns:ng="http://angularjs.org" id="ng-app" ng-app="comentario" class="no-js lt-ie9 " lang="en"> <![endif]-->
<!--[if gt IE 8]><!--> <html ng-app="comentario" class="no-js" lang="en"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
